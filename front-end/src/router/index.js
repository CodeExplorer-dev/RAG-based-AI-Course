 ...
 const routes = [
   ...
   },
   {
     ...
     redirect: '/courses',
     children: [
       { path: 'courses', name: 'Courses', component: () => import('../views/CourseListView.vue'), meta: { title: '课程列表', icon: 'Notebook', roles: ['student'] } },
       { path: 'courseware', name: 'Courseware', component: () => import('../views/CoursewareView.vue'), meta: { title: '课件管理', icon: 'FolderOpened', roles: ['student'] } },
       { path: 'chat/:courseId?', name: 'Chat', component: () => import('../views/ChatView.vue'), meta: { title: 'AI 问答', icon: 'ChatDotRound', roles: ['student', 'teacher'] } },
       { path: 'knowledge-graph/:courseId?', name: 'KnowledgeGraph', component: () => import('../views/KnowledgeGraphView.vue'), meta: { title: '知识图谱', icon: 'Share', roles: ['student', 'teacher'] } },
       { path: 'ask-teacher', name: 'AskTeacher', component: () => import('../views/AskTeacherView.vue'), meta: { title: '向老师提问', icon: 'Message', roles: ['student'] } },
       { path: 'statistics', name: 'Statistics', component: () => import('../views/StatisticsView.vue'), meta: { title: '提问统计', icon: 'DataAnalysis', roles: ['student'] } },
     ]
   },
   {
     path: '/teacher',
   ...
   },
   {
     ...
     children: [
       ...
       { path: 'statistics', name: 'AdminStats', component: () => import('../views/StatisticsView.vue'), meta: { title: '系统统计', icon: 'DataAnalysis', roles: ['admin'] } },
     ]
   }
 ]
