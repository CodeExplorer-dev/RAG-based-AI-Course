     ...
     <el-aside :width="isCollapsed ? '64px' : '230px'" class="layout-aside">
       ...
       >
         ...
         <template v-if="role === 'admin'">
           ...
           <el-menu-item index="/admin/statistics"><el-icon><DataAnalysis /></el-icon><span>系统统计</span></el-menu-item>
         </template>
       </el-menu>
     </el-aside>
     <el-container>
 ...
 import { Notebook, FolderOpened, ChatDotRound, Share, DataAnalysis, Fold, UserFilled, SwitchButton, Odometer, User, Message } from '@element-plus/icons-vue'
 ...
 const activeMenu = computed(() => {
   ...
   if (role.value === 'student') return '/' + parts.slice(0, 2).join('/')
